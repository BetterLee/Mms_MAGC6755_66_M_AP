...
public final class EmojiPalettesView extends LinearLayout implements OnTabChangeListener,
    ...
    public void startEmojiPalettes(final KeyVisualAttributes keyVisualAttr) {    	
    	final String switchToAlphaLabel = "abc";         
        final KeyboardIconsSet iconSet;
        
        final int deleteIconResId = R.drawable.sym_keyboard_delete_lxx_light;	//iconSet.getIconResourceId(KeyboardIconsSet.NAME_DELETE_KEY);
        if (deleteIconResId != 0) {
            mDeleteKey.setImageResource(deleteIconResId);
        }
//        final int spacebarResId = iconSet.getIconResourceId(KeyboardIconsSet.NAME_SPACE_KEY);
